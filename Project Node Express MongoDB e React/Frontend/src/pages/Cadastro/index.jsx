...
function Cadastro(){
    ...
    return(
        <div className="max-w-md  mx-auto border mt-10 bg-white p-8 border-gray-300 rounded-lg shadow-lg ">
            <h2 className="text-2xl front-bold mb-6 text-center text-gray-800">Cadastro</h2>
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                <input ref = {nameRef} placeholder="Nome" type="text" className="w-full py-2 botder border-gray-300 rounded-md focus:outline-none"/>
